...
## How Do I Build a Workflow? {.smaller}
...
### Worflows Are Hierarchical: Data Cleaning Steps
...
## Creating Quarto documents {.smaller}
...
Let's take a few minutes and have you peruse the [Quarto site](https://quarto.org/docs/get-started/hello/rstudio.html) to build familiarity (I still access it all the time when I forget how to do specific things)
...
::: column
Reminders: - Problem set 1 due next Monday at 12:01 AM (grace period until 9 AM) - Make sure to check out the readings - There are exercises at the end that can be helpful to do. You can even download the directory of the bookdown/quarto book from GitHub (link in book) - Next time: - Bring your data, ideally loaded into R (or at a piece of it is) - Part 1: Reproducibility and Using Workflows to Reflect Your Values - Part 2: Data Manipulation: `dplyr`
:::
:::
