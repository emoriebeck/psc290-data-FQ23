...
1. In the code chunk below, complete the following:
    ...
    - Use the `load()` and `url()` functions to download the `df_event` dataframe from the url: `https://github.com/emoriebeck/psc290-data-FQ23/05-assignments/02-ps2/ps2-data.RData`
...
1. In the code chunk below, complete the following:
    ...
    - Use the `load()` and `url()` functions to download the `df_school_all` dataframe from the url: `https://github.com/emoriebeck/psc290-data-FQ23/05-assignments/02-ps2/ps2-data.RData`
